...
public class TitleBar extends FrameLayout {
    ...
    private RelativeLayout divTitlePanel, pnlMiddle;
    ...
    public void setBackground(Drawable background) {
        divTitlePanel.setBackgroundDrawable(background);
    }

    @Override
    public void setBackgroundColor(int color) {
        divTitlePanel.setBackgroundColor(color);
    }

    @Override
    public void setBackgroundResource(int resid) {
        divTitlePanel.setBackgroundResource(resid);
    }
    ...
    private void init(Context cx, AttributeSet attrs) {
        ...
        divTitlePanel = titleView.findViewById(R.id.divTitlePanel);
