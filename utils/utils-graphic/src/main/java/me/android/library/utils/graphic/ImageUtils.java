...
package me.android.library.utils.graphic;
...
public class ImageUtils {
    ...
    private static DisplayImageOptions defaultOptions = getDefaultBuilder()
            .build();
     ...
     * String imageUri = "assets://image.png"; // from assets
     *
     * @param imageFile assets目录下的图片文件
     * @return
     */
