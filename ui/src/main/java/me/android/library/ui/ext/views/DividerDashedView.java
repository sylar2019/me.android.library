...
public class DividerDashedView extends View {
    ...
    private void init(Context cx, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            TypedArray a = cx.obtainStyledAttributes(attrs, R.styleable.DividerDashedView);
            lineColor = a.getColor(R.styleable.DividerDashedView_dashed_line_color, Line_COLOR);
            dashWidth = a.getDimensionPixelSize(R.styleable.DividerDashedView_android_dashWidth, DASH_WIDTH);
            dashGap = a.getDimensionPixelSize(R.styleable.DividerDashedView_android_dashGap, DASH_GAP);
            orientation = a.getInt(R.styleable.DividerDashedView_android_orientation, HORIZONTAL);
            a.recycle();
        }
