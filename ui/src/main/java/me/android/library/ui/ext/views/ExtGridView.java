 ...
 * See {@link ExtGridView#addHeaderView(View, Object, boolean)}
 * See {@link ExtGridView#addFooterView(View, Object, boolean)}
 */
public class ExtGridView extends GridView {
     ...
     * <p>This is intended as a me.android.library.utils.base class; you will probably not need to
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            int realLeft = ExtGridView.this.getPaddingLeft() + getPaddingLeft();
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = ExtGridView.this.getMeasuredWidth()
                    - ExtGridView.this.getPaddingLeft()
                    - ExtGridView.this.getPaddingRight();
