...
import me.android.library.utils.sharesdk.onekeyshare.EditPageFakeActivity;
import me.android.library.utils.sharesdk.onekeyshare.PicViewer;
...
public class EditPage extends EditPageFakeActivity implements OnClickListener, TextWatcher {
    ...
    private void initAtUserView() {
        ...
        for (Platform platform : platforms) {
            ...
            if (isShowAtUserLayout(platformName)) {
                ...
                TextView atDescTextView = view.findViewById(getIdRes(activity, "atDescTextView"));
                TextView atTextView = view.findViewById(getIdRes(activity, "atTextView"));
    ...
    private View makeImageItemView(final ImageInfo imageInfo) {
        ...
        ImageView imageView = view.findViewById(getIdRes(activity, "imageView"));
