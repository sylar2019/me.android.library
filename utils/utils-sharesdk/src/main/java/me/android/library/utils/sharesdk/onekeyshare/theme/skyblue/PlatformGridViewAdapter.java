...
package me.android.library.utils.sharesdk.onekeyshare.theme.skyblue;
...
import me.android.library.utils.sharesdk.onekeyshare.CustomerLogo;
import me.android.library.utils.sharesdk.onekeyshare.ShareCore;
...
public class PlatformGridViewAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolder.checkedImageView = view.findViewById(getIdRes(context, "checkedImageView"));
            viewHolder.logoImageView = view.findViewById(getIdRes(context, "logoImageView"));
            viewHolder.nameTextView = view.findViewById(getIdRes(context, "nameTextView"));
